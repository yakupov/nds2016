...
public class StupidPerformanceTest {
    private static final double[][] pop1 = new double[][]{
    ...
    private static final double[][] pop2 = new double[][]{
    ...
    private void testNew(double[][] pop, int runs, int warmup) {
        ...
        for (int cnt = 0; cnt < runs; ++cnt) {
            ...
            final int[] ranks = ppsn2014.performNds(localPop);
    ...
    private void testOld(double[][] pop, int runs, int warmup) {
        double begin = 0;
    ...
    public void testNew1() throws Exception {
        testNew(pop1, 1000000, 100000);
    }

    @Ignore
    @Test
    public void testOld1() throws Exception {
        testOld(pop1, 1000000, 100000);
    }

    @Ignore
    @Test
    public void testNew2() throws Exception {
        testNew(pop2, 5000, 500);
    }

    @Ignore
    @Test
    public void testOld2() throws Exception {
        testOld(pop2, 5000, 500);
    }
}

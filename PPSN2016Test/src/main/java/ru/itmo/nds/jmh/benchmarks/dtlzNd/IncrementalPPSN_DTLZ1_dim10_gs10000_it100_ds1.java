 ...
 */
public class IncrementalPPSN_DTLZ1_dim10_gs10000_it100_ds1 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ1_dim10_gs10000_it100_ds1.class
                .getResourceAsStream("dtlz1_dim10_gen10000_iter100_dataset1.json")) {

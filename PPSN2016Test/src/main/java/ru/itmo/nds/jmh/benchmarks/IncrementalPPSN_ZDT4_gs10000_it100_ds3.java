 ...
 */
public class IncrementalPPSN_ZDT4_gs10000_it100_ds3 extends IncrementalPPSN_ZDT1_gs10000_it100_ds1 {
    @Setup(Level.Trial)
    public void init() throws Exception {
        frontStorage = new FrontStorage();

        try (InputStream is = IncrementalPPSN_ZDT4_gs10000_it100_ds3.class
                .getResourceAsStream("ppsn/zdt4_gen10000_iter100_dataset3.json")) {

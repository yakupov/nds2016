 ...
 */
public class IncrementalPPSN_DTLZ4_dim3_gs10000_it100_ds1 extends CommonPPSNBenchmarks {
    @Override
    FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ4_dim3_gs10000_it100_ds1.class
                .getResourceAsStream("ppsn/dtlz4_dim3_gen10000_iter100_dataset1.json")) {

 ...
 */
public class IncrementalPPSN_DTLZ1_dim4_gs10000_it100_ds0 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ1_dim4_gs10000_it100_ds0.class
                .getResourceAsStream("dtlz1_dim4_gen10000_iter100_dataset0.json")) {

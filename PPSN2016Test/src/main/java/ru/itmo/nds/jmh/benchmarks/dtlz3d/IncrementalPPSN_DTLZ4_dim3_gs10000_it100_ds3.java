 ...
 */
public class IncrementalPPSN_DTLZ4_dim3_gs10000_it100_ds3 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        ...
        try (InputStream is = IncrementalPPSN_DTLZ4_dim3_gs10000_it100_ds3.class
                .getResourceAsStream("dtlz4_dim3_gen10000_iter100_dataset3.json")) {

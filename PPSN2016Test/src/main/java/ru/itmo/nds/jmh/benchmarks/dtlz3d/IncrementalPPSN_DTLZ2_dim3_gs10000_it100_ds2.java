 ...
 */
public class IncrementalPPSN_DTLZ2_dim3_gs10000_it100_ds2 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        ...
        try (InputStream is = IncrementalPPSN_DTLZ2_dim3_gs10000_it100_ds2.class
                .getResourceAsStream("dtlz2_dim3_gen10000_iter100_dataset2.json")) {

 ...
 */
public class IncrementalPPSN_ZDT3_gs10000_it100_ds1 extends IncrementalPPSN_ZDT1_gs10000_it100_ds1 {
    @Setup(Level.Trial)
    public void init() throws Exception {
        frontStorage = new FrontStorage();

        try (InputStream is = IncrementalPPSN_ZDT3_gs10000_it100_ds1.class
                .getResourceAsStream("ppsn/zdt3_gen10000_iter100_dataset1.json")) {

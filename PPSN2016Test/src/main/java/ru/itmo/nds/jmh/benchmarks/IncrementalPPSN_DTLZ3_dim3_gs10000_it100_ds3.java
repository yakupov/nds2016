 ...
 */
public class IncrementalPPSN_DTLZ3_dim3_gs10000_it100_ds3 extends CommonPPSNBenchmarks {
    @Override
    FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ3_dim3_gs10000_it100_ds3.class
                .getResourceAsStream("ppsn/dtlz3_dim3_gen10000_iter100_dataset3.json")) {
